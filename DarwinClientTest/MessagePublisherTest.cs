...
namespace DarwinClient.Test
{
    public class MessagePublisherTest
    {
        ...
        {
            var parser = new ToDarwinMessageParser(Substitute.For<ILogger>());
            var target = Substitute.For<IObserver<Message>>();
            var publisher = new MessagePublisher(parser, Substitute.For<ILogger>());
        ...
        {
            var parser = new ToDarwinMessageParser(Substitute.For<ILogger>());
            var target1 = Substitute.For<IObserver<Message>>();
            var target2 = Substitute.For<IObserver<Message>>();
            var publisher = new MessagePublisher(parser, Substitute.For<ILogger>());
        ...
        [Fact]
        public void DisposeUnsunscribes()
        {
            var parser = new ToDarwinMessageParser(Substitute.For<ILogger>());
            var target1 = Substitute.For<IObserver<Message>>();
            var target2 = Substitute.For<IObserver<Message>>();
